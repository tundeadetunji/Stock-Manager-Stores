...
#Region "Log"
	...
	''' </summary>
	''' <param name="log_title"></param>
	''' <param name="log_memo"></param>
	''' <param name="user_id__"></param>
	''' <param name="client_id__"></param>
	''' <param name="item_id__"></param>
	''' <param name="log_trigger"></param>
